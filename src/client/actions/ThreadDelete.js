...
class ThreadDeleteAction extends Action_1.default {
    handle(data) {
        ...
        this.client.emit(Constants_1.Events.THREAD_DELETE, thread);
        return { thread };
    }
}
ThreadDeleteAction.default = ThreadDeleteAction;
