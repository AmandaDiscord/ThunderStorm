...
export declare type ChannelDatas = Discord.DMChannelData | Discord.TextChannelData | Discord.CategoryChannelData | Discord.NewsChannelData | Discord.VoiceChannelData | Discord.StageChannelData | Discord.StoreChannelData;
export declare type AnyChannel = import("./structures/NewsChannel") | import("./structures/TextChannel") | import("./structures/GuildChannel") | import("./structures/StageChannel") | import("./structures/StoreChannel") | import("./structures/VoiceChannel") | import("./structures/CategoryChannel") | import("./structures/ThreadNewsChannel") | import("./structures/ThreadTextChannel") | import("./structures/DMChannel");
