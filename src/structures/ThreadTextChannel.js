...
class ThreadTextChannel extends TextChannel_1.default {
    ...
    _patch(data) {
        ...
        if (data.parent_id)
            this.parent = new PartialChannel(this.client, { id: data.parent_id, guild_id: data.guild_id, type: Constants_1.default.ChannelTypes[0] });
    }
}
ThreadTextChannel.default = ThreadTextChannel;
