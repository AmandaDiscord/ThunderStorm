...
function handle(data: import("./internal").InboundDataType<keyof import("./internal").CloudStormEventDataTable>, client: import("./structures/Client")) {
	...
	if (data.t === "CHANNEL_CREATE") {
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"CHANNEL_DELETE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"CHANNEL_PINS_UPDATE"> = data;
		client.emit(Constants.EVENTS.CHANNEL_PINS_UPDATE, typed.d);
	} else if (data.t === "CHANNEL_UPDATE") {

		// @ts-ignore
		const typed: import("./internal").InboundDataType<"CHANNEL_UPDATE"> = data;
		client.emit(Constants.EVENTS.CHANNEL_UPDATE, createChannel(typed.d, client) as any);
	} else if (data.t === "GUILD_BAN_ADD") {

		// @ts-ignore
		const typed: import("./internal").InboundDataType<"GUILD_BAN_ADD"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"GUILD_BAN_REMOVE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"GUILD_EMOJIS_UPDATE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"GUILD_MEMBERS_CHUNK"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"GUILD_MEMBER_ADD"> = data;
		client.emit(Constants.EVENTS.GUILD_MEMBER_ADD, new GuildMember(typed.d, client));
	} else if (data.t === "GUILD_MEMBER_REMOVE") {

		// @ts-ignore
		const typed: import("./internal").InboundDataType<"GUILD_MEMBER_REMOVE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"GUILD_UPDATE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"INVITE_CREATE"> = data;
		client.emit(Constants.EVENTS.INVITE_CREATE, new Invite(typed.d as any, client));
	} else if (data.t === "INVITE_DELETE") {

		// @ts-ignore
		const typed: import("./internal").InboundDataType<"INVITE_DELETE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"MESSAGE_DELETE_BULK"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"MESSAGE_REACTION_REMOVE_EMOJI"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"THREAD_CREATE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"THREAD_DELETE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"THREAD_LIST_SYNC"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"THREAD_UPDATE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"THREAD_MEMBER_UPDATE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"THREAD_MEMBERS_UPDATE"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"TYPING_START"> = data;
		...
		// @ts-ignore
		const typed: import("./internal").InboundDataType<"USER_UPDATE"> = data;
