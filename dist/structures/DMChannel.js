    ...
    constructor(data, client) {
        ...
        if (data.recipients) {
            ...
            for (const recipient of data.recipients) {
                ...
                this.recipients.set(recipient.id, recipient.id === ((_d = this.client.user) === null || _d === void 0 ? void 0 : _d.id) ? this.client.user : new User_1.default(recipient, this.client));
            }
        }
    }
    toJSON() {
